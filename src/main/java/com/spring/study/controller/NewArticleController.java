...
public class NewArticleController {
	private static final Logger logger = LoggerFactory.getLogger(NewArticleController.class);
	...
	//TODO Resolver가 작동을 안함 오류찾아내기 //페이지번호가 무조건 들어와야하는 API인가???
	public @ResponseBody Map<String, Object> getArticleList(@PathVariable int page, @RequestParam(defaultValue = "old") String sort) {																					
	...
	public @ResponseBody Map<String, Object> getArticleList2( @PathVariable int page,@RequestParam(required = false, defaultValue = "old") String sort) {
		ArticleParam reqParam = new ArticleParam.Builder(pageSize)
										.page(page)
										.useMore(true)
										.sort(sort)
